...
- Remove deprecated Social and Feedback Configuration settings
...
Collections:
- Add preview to global backgrounds Collections grid
...
Gitify:
- Remove renderResources from Gitify package list
